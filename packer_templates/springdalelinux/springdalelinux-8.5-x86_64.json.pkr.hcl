...
variable "iso_checksum" {
  type    = string
  default = "7b2b3c20e202bc8b0791e9a09555961dc7ef533cc6e5c6daac980f335a55614f"
}

variable "iso_name" {
  type    = string
  default = "Springdale%20Linux-8.5-x86_64-netinst.iso"
}

variable "ks_path" {
  type    = string
  default = "8-netinst/ks.cfg"
}
...
variable "mirror" {
  type    = string
  default = "http://springdale.princeton.edu/data/springdale"
}

variable "mirror_directory" {
  type    = string
  default = "8.5/x86_64/iso"
}
...
variable "template" {
  type    = string
  default = "springdalelinux-8.5-x86_64"
}
...
locals {
  ...
  http_directory  = "${path.root}/../springdalelinux/http"
}
