...
variable "iso_checksum" {
  type    = string
  default = "70b19f7f0178d594b409822c724c2b7c0834716df1ad7e13dd10e1580380c7c9"
}

variable "iso_name" {
  type    = string
  default = "debian-11.5.0-arm64-netinst.iso"
}
