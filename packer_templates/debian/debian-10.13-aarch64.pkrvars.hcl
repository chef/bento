...
variable "iso_checksum" {
  type    = string
  default = "a20a5437e243186ac8d678202cf55a253e8d37df2b187da885796d5071ba829f"
}

variable "iso_name" {
  type    = string
  default = "debian-10.13.0-arm64-netinst.iso"
}
