...
variable "iso_checksum" {
  type    = string
  default = "b369b7eaeee2e897649bf3a8d00036e596149605456d038cad8da4a809333f3d"
}

variable "iso_name" {
  type    = string
  default = "debian-11.4.0-i386-netinst.iso"
}
