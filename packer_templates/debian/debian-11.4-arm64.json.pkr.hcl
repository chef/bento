...
variable "iso_checksum" {
  type    = string
  default = "0193e7b555011a6f8fa6ad132066873fad4a5396a9ebfca8fd179122bb4c7fdd"
}

variable "iso_name" {
  type    = string
  default = "debian-11.4.0-arm64-netinst.iso"
}
