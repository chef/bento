...
variable "iso_checksum" {
  type    = string
  default = "cdb53762803a5b71590f2fdfe44eb1c8351d28d1e2753cfc1b3f0bd654cc99e1"
}

variable "iso_name" {
  type    = string
  default = "debian-10.11.0-arm64-netinst.iso"
}
