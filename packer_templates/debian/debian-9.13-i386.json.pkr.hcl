...
variable "iso_checksum" {
  type    = string
  default = "27de998af87007bf5daa3030d3863d3ef801b948c29f5bbce232be4f928eedba"
}

variable "iso_name" {
  type    = string
  default = "debian-9.13.0-i386-netinst.iso"
}
