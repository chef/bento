...
variable "iso_checksum" {
  type    = string
  default = "b422b5f390f9bd05f5c71783099b2b9a925e7256d7907b9be613ece4a1fb4124"
}

variable "iso_name" {
  type    = string
  default = "FreeBSD-12.2-RELEASE-i386-disc1.iso"
}
...
variable "mirror_directory" {
  type    = string
  default = "releases/i386/i386/ISO-IMAGES/12.2"
}
