...
variable "iso_checksum" {
  type    = string
  default = "606435637b76991f96df68f561badf03266f3d5452e9f72ed9b130d96b188800"
}
...
variable "mirror_directory" {
  type    = string
  default = "releases/amd64/amd64/ISO-IMAGES/12.4"
}
