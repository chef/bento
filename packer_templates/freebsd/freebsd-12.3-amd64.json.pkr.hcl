...
variable "iso_checksum" {
  type    = string
  default = "5f0c10ff9af582c7fca90f65868702aa02e80f344c186f0bc75639a687d65641"
}

variable "iso_name" {
  type    = string
  default = "FreeBSD-12.3-RELEASE-amd64-disc1.iso"
}
...
variable "mirror_directory" {
  type    = string
  default = "releases/amd64/amd64/ISO-IMAGES/12.3"
}
