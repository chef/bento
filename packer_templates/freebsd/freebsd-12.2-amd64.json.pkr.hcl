...
variable "iso_checksum" {
  type    = string
  default = "289522e2f4e1260859505adab6d7b54ab83d19aeb147388ff7e28019984da5dc"
}

variable "iso_name" {
  type    = string
  default = "FreeBSD-12.2-RELEASE-amd64-disc1.iso"
}
...
variable "mirror_directory" {
  type    = string
  default = "releases/amd64/amd64/ISO-IMAGES/12.2"
}
