...
source "virtualbox-iso" "autogenerated_1" {
  ...
  iso_url                 = "${var.mirror}/sol-11_4-ai-x86.iso"
  memory                  = "${var.memory}"
