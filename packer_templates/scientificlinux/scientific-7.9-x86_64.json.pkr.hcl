...
variable "iso_checksum" {
  type    = string
  default = "7ac643e164c4a0da0b9f33411c68368cf908e0c34254904044957a3ca7793934"
}

variable "iso_name" {
  type    = string
  default = "SL-7-DVD-x86_64.iso"
}
...
variable "mirror" {
  type    = string
  default = "http://www.gtlib.gatech.edu/pub/scientific"
}

variable "mirror_directory" {
  type    = string
  default = "7.9/x86_64/iso"
}
...
locals {
  build_timestamp = "${legacy_isotime("20080506150405")}"
...
build {
  ...
  provisioner "shell" {
    ...
    scripts           = ["${path.root}/../centos/scripts/update.sh", "${path.root}/../_common/motd.sh", "${path.root}/../_common/sshd.sh", "${path.root}/../centos/scripts/networking.sh", "${path.root}/../_common/vagrant.sh", "${path.root}/../_common/virtualbox.sh", "${path.root}/../_common/vmware.sh", "${path.root}/../_common/parallels.sh", "${path.root}/../centos/scripts/cleanup.sh", "${path.root}/../_common/minimize.sh"]
  }
