...
boot_command            = ["<wait><up>e<wait><down><down><end><wait> inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/rhel/10ks.cfg inst.repo=https://yum.oracle.com/repo/OracleLinux/OL10/baseos/latest/aarch64/ <leftCtrlOn>x<leftCtrlOff>"]
