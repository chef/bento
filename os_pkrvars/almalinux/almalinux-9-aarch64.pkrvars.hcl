...
#boot_command            = ["e<wait><down><down><end><wait> inst.text inst.ks=https://raw.githubusercontent.com/chef/bento/builds_pipeline_testing/packer_templates/http/rhel/9ks.cfg <leftCtrlOn>x<leftCtrlOff>"]
