...
os_version              = "14.4"
os_arch                 = "aarch64"
iso_url                 = "https://download.freebsd.org/releases/arm64/aarch64/ISO-IMAGES/14.4/FreeBSD-14.4-RELEASE-arm64-aarch64-disc1.iso"
iso_checksum            = "file:https://download.freebsd.org/releases/arm64/aarch64/ISO-IMAGES/14.4/CHECKSUM.SHA256-FreeBSD-14.4-RELEASE-arm64-aarch64"
