...
```
bento build --cpus 2 packer_templates/debian/debian-11.5-i386.json
```
...
To build Debian 11.5 32bit boxes for all possible providers (simultaneously)

```
$ cd packer_templates/debian
$ packer build debian-11.5-i386.json
```
